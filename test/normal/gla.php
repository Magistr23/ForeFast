      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <p>Не забывайте и про правила сервера, которы были написаны на странице "<a href="http://helperstaff.ru">Главная</a>"</p><p>Посмотреть кураторов можно <a href="https://helperstaff.ru#curator">тут</a></p></div> <h1><p>Так же на странице "<a href="http://helperstaff.ru/?pos=memorial">Ушедшие Админы</a>" можно ознакомиться с Админами, которые раньше присматривали за проектами (Summer, Mega, Sweet)</h1>
