...
Ну и как же без правил, вы должны знать их на зубок или же большую их часть. Все правила написаны на странице "<a href="http://staff.helperstaff.ru">Главная</a>"</p></div>
    ...
    echo '<div class="col-sm-3"></div>
        <div class="col-sm-6"><div class="panel panel-info"><div class="panel-heading"><div class="sidebar-header text-center">'.$row['vk_name'].'
              			...
              			<p><img style="width: 150px; border-radius: 10px; border: 3px solid #808080;" class="hidden-sm" src="'.$row['img_link'].'"></p>
                            <figcaption>'.$row['pos1'].' <br><span style="font-family: cursive;">'.$row['nickname'].'</span>';
           if (!empty($row['comment'])) {
                              echo '<blockquote><span style="font-family: cursive;">'.$row['comment'].'</span></blockquote>';
           }
           echo '
                            <br><a href="'.$row['vk_link'].'" class="button9 btn btn-default" aria-label="Left Align">
                              ВК
                            </a></figcaption>
                            </figure>
                          </div>';
