...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
  <div class="panel panel-default">
    ...
    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
      <div class="panel-body">
        Тест создан для проверки знаний правил сервера.
        <br>Для того что бы начать тест, нажмите на кнопку "Начать тест"
        <br>После того, как вы нажмёте на кнопку, вам откроется окно с вопросом и полем для ответа.
        <br>Так же после нажатия запуститься время, оно остановиться когда вы нажмёте на кнопку "проверить" на последнем вопросе.
        <br>Если вы в первый раз ответили и вам не понравилось время, просто попробуйте начать сначала, для того что бы тест начался сначала, просто обновите страницу.
        <br>Ответы на вопросы являются числовыми. Например. 3, 3.12 и т.д.
        <br>Правила которые на этом сайте могут быть не точными.
