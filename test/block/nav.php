<nav role="navigation" class="navbar navbar-inverse"  style="background-color: #808080; border: 1px solid #808080;">
    ...
    <ul class="dropdown-menu">
      ...
      <li><a href="https://helperstaff.ru/?pos=glm">Гл.Модеры</a></li>
                        ...
                        <li> <div class="btn-group" role="group">
    <button type="button" class="btn <?php if ($first_part=="admin" || $first_part=="gla" || $first_part=="owner")  {echo "ch-li"; } else  {echo "btn-default";} ?> dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
      Админы
      <span class="caret"></span>
    </button>
    <ul class="dropdown-menu">
      ...
      <li><a href="https://helperstaff.ru/?pos=owner">Владельцы</a></li>
    </ul>
  </div> </li>
