...
Глава БД/по всем вопросам к - <a href='https://vk.com/mr.skyder'>https://vk.com/mr.skyder</a>
            <div>
            <hr>
            	<ol><h1>Инструкция, как стать ФорФастером!</h1>
            		<li>Подпишитесь на группу VK - <a href="https://vk.com/forefast">@forefast</a>. Также прочитай подробности в группе/ознакомься с кланом.</li>
            		<li>Найди в группе закреплённый пост с набором в клан - <a href="https://vk.com/topic-190985262_48088651">Перейти в пост</a></li>
            		<li><dl>
            			<dt>Запрещается писать в обсуждение!</dt>
            			<ul>
            				<li><dd> отправлять дубликаты заявок.</dd></li>
            				<li><dd> торопить с рассмотрением анкеты администраторов или модераторов банды.</dd></li>
            				<li><dd> спам, сообщения, не имеющие никакого смысла к заявке.</dd></li></ul>
            			<li><dt>Для вступления вы должны быть подписанный на группу. Вам от 12+ лет. Заполните анкету следуя формату ниже.</dt></li>
            			<ul>
            				<li><dd>Ваш ник. (В Майнкрафте)</dd></li>
            				<li><dd>Ваш возраст.</dd></li>
            				<li><dd>На каком сервере вы больше всего играете? Можно указать несколько.</dd></li>
            				<li><dd>Ваш уровень ПВП (1/10).</dd></li>
            				<li><dd>Сколько времени готовы уделять банде?</dd></li>
            				<li><dd>По каким причинам вы хотите попасть в банду? Или для чего?</dd></li>
            				<li><dd>Наличие дискорда.</dd></li>
            				<li><dd>Кратко о себе.</dd></li></ul>
            		</dl></li>
            		<li>Дождись когда твою заявку осмотрят. Если твою заявку одобрили, то напиши Кириллу по поводу вступления в клан (ссылка на него будет в ответном сообщении)</li>
            	</ol> 
            	<hr>
